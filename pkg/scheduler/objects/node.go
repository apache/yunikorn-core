...
func (sn *Node) preAllocateConditions(ask *AllocationAsk) error {
	return sn.preConditions(ask, true)
}

// Checking pre-conditions in the shim for a reservation.
func (sn *Node) preReserveConditions(ask *AllocationAsk) error {
...
func (sn *Node) preConditions(ask *AllocationAsk, allocate bool) error {
