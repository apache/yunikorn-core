...
func TestIncreaseTrackedResource(t *testing.T) {
	...
	actualResources := userTracker.GetResource()
...
//todo test cases for different applications each with different group linkage
...
func TestDecreaseTrackedResource(t *testing.T) {
	...
	actualResources1 := userTracker.GetResource()
